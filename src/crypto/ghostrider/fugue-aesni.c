...
void Compress512(sph_fugue512_context *ctx, const unsigned char *pmsg, unsigned int uBlockCount)
{
...
void Final512(sph_fugue512_context *ctx, BitSequence *hashval)
{
...
HashReturn fugue512_Init(sph_fugue512_context *ctx, int nHashSize)
{
	int i;
